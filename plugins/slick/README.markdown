...
lazyLoaded | event, slick, image, imagenesource | Fires after image loads lazily
lazyLoadError | event, slick, image, imagenesource | Fires after image fails to load
